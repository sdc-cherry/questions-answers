...
\COPY product FROM '~/Git/HackReactor/cohort/FinalOutput/SDC/DB/product.csv' DELIMITER ',' CSV HEADER;
\COPY questions FROM '~/Git/HackReactor/cohort/FinalOutput/SDC/DB/questions.csv' DELIMITER ',' CSV HEADER;
\COPY answers FROM '~/Git/HackReactor/cohort/FinalOutput/SDC/DB/answers.csv' DELIMITER ',' CSV HEADER;
\COPY answers_photos FROM '~/Git/HackReactor/cohort/FinalOutput/SDC/DB/answers_photos.csv' DELIMITER ',' CSV HEADER;
